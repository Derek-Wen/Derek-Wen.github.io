...
<div style="display:flex; justify-content:space-between;">
  <img src="../../assets/img/song1.png" alt="Image 1" style="width:35%; margin-right:10px;">
  <p style="width:35%; margin-left:10px;"> 
    ...
    <br>
    <a href="https://soundcloud.com/dwennn/trust-u-ft-riensu-ri4h-maxrrss-manni-yoku">listen on soundcloud</a>
  </p>
</div>

## giving up (ft. riensu & maxrrss)
<div style="display:flex; justify-content:space-between;">
  <img src="../../assets/img/song2.png" alt="Image 1" style="width:25%; margin-right:10px;">
  <p style="width:35%; margin-left:10px;"> 
    ...
    <br>
    <a href="https://soundcloud.com/dwennn/giving-up-ft-riensu-maxrrss">listen on soundcloud</a>
  </p>
</div>

## don't go (ft. riensu & manni ✰)
<div style="display:flex; justify-content:space-between;">
  <img src="../../assets/img/song3.png" alt="Image 1" style="width:15%; margin-right:10px;">
  <p style="width:35%; margin-left:10px;"> 
...
<div style="display:flex; justify-content:space-between;">
  ...
  <p style="width:35%; margin-left:10px;"> 
    ...
    <br>
    <a href="https://soundcloud.com/dwennn/tumbleft-riensu-yoku">listen on soundcloud</a>
  </p>
</div>
...
<div style="display:flex; justify-content:space-between;">
  ...
  <p style="width:35%; margin-left:10px;"> 
    ...
    <br>
    <a href="https://soundcloud.com/dwennn/reaching-too-far">listen on soundcloud</a>
  </p>
</div>